      ...
      <div className="product-information">
        ...
        <div className="product-basket-quantity">
          ...
          <select
            ...
            name="detail-purchase-quantity"
            id="detail-purchase-quantity"
            className="detail-purchase-quantity"
            onChange={(e) =>
              handleChangeBasket(
          ...
          <button
            className="product-basket-delete"
            onClick={() =>
              handleChangeBasket(
                productDetail.product,
                null,
          ...
          <div className="product-price">
            <h2 className="product-price-unit">
              Unit price : {productDetail.product.price}€
            </h2>
            <h2 className="product-price-multiple">
              Actual price :{" "}
              {Math.round(
